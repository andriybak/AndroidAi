...
public class DogBreedClassifier implements Classifier
{
            ...
            throws IOException
    {
        ...
        try
        {
            ...
            dogBreedClassifier.tfLite = new Interpreter(Utils.loadModelFile(assetManager, modelFilename), options);
        }
        catch (Exception e)
        {
    ...
    public ArrayList<Recognition> recognizeImage(Bitmap bitmap)
    {
        ...
        ArrayList<Recognition> onlyDogClassDetections = getOnlyDogClasses(detections);
        final ArrayList<Recognition> dogRecognitions = nms(onlyDogClassDetections);
        //recognize dog breed of each box
    ...
    private ArrayList<Recognition> getOnlyDogClasses(ArrayList<Recognition> results)
    {
        ...
        {
            int resultClass = item.getDetectedClass();
            if ((resultClass >= 14 && resultClass <= 22) || resultClass == 23 || resultClass == 77 || resultClass == 0)
            {
